...
from sqlalchemy import TIMESTAMP, BigInteger, ForeignKey, Index, Text, text
...
class Municipality(Base):
    ...
    __table_args__ = (Index("idx_municipalities_county", "county_code"),)
...
class Address(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_addresses_locality", "locality_code", postgresql_where=text("deleted_at IS NULL")
        ),
    )
    ...
    flat_no: Mapped[str | None] = mapped_column(Text)
